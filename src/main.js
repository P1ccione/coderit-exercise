...
const i18n = createI18n({
  ...
  messages: {
    ...
    es: {
      ...
      form_aggiunta_professori: "FORMULARIO DE AGREGAR PROFESOR",
      form_aggiunta_corsi: "FORMULARIO DE AGREGAR CURSO",
      form_aggiunta_docenze: "FORMULARIO DE AGREGAR CONFERENCIA",
      invio: "ENVIAR",
      cancella: "BORRAR",
      chiudi: "CERRAR",
      elimina: "ELIMINAR",
    ...
    de: {
      ...
      form_aggiunta_professori: "LEHRER HINZUFÜGEFORMULAR",
      form_aggiunta_corsi: "KURS HINZUFÜGEFORMULAR",
      form_aggiunta_docenze: "VORLESUNG HINZUFÜGEFORMULAR",
      invio: "SENDEN",
      cancella: "LÖSCHEN",
      chiudi: "SCHLIEßEN",
      elimina: "LÖSCHEN",
    ...
    fr: {
      ...
      form_aggiunta_professori: "FORMULAIRE D'AJOUT D'ENSEIGNANT",
      form_aggiunta_corsi: "FORMULAIRE D'AJOUT DE COURS",
      form_aggiunta_docenze: "FORMULAIRE D'AJOUT DE CONFÉRENCE",
      invio: "ENVOYER",
      cancella: "EFFACER",
      chiudi: "FERMER",
      elimina: "SUPPRIMER",
